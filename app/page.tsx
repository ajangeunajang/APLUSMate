                  ...
                  return (
                    <a
                      ...
                      href={`/pdf/${encodeURIComponent(
                        pdf.public_id
                      )}?filename=${encodeURIComponent(pdf.filename)}`}
                      target="_self"
                    ...
                    >
                      <div className="w-full h-full bg-gray-100 hover:bg-gray-200 transition-color duration-500 rounded-[24px] flex flex-col items-center justify-center gap-2 transition-colors duration-300 cursor-pointer">
                        {imageSrc && !hasImageError ? (
                          <div className="w-full h-full border-1 border-gray-300 rounded-[16px] overflow-hidden">
                            <img
                              src={imageSrc}
                              alt={pdf.filename}
                              ...
                              onError={(e) => {
                                ...
                                setImageErrors((prev) =>
                                  new Set(prev).add(pdf.public_id)
                                );
                              }}
                            />
                          </div>
